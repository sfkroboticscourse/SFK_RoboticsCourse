...
class SimpleSubscriber(Node):
    ...
    def __init__(self):
        ...
        # )
        #
        # STUDENT TODO: Fill in the SAME topic name you used in the publisher!
        self.subscription = self.create_subscription(
            String,
            'how?',  # MUST match your publisher's topic!
            self.listener_callback,
            10
        )

        self.get_logger().info('Simple Subscriber Node has started!')
        self.get_logger().info(f'Listening to topic: YOUR_TOPIC_NAME_HERE')
